...
//consulta 0 que son los datos de los clientes
...
<body>
<!-- Todas los apartados de consultas que se eligen por radio con un value determinado, primer formulario
que se ejecuta con get-->
...
<br>
<!--El formulario que se muestra al pulsar submit procesar se ejecuta con post-->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    switch ($_REQUEST['consulta']){
        /*Switch con todos los casos de consultas, y se llama a esas consultas desde AccesoDatos*/
        /*El switch llama a la función verresu(y con parámetro los datos de la consulta)*/
        //En el case 1 hace falta los datos de precio
        ...
        //En el case 5 hacen falta los datos de cliente
...
/*Función que coge por parámetro los datos de la consulta de AccesoDatos*/
function verresu ( $datos){
    ...
    echo "<table>";
    $cabecera=false;
    //Si hay datos se van leyendo en formato tabla
